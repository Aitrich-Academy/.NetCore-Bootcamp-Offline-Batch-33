...
namespace Domain.Services.Jobs.Interfaces
{
    public interface IJobService
    {
        ...
        public Task<JobDto> CreateJobAsync(CreateJobDto dto, Guid companyId);
        Task<Job?> GetJobEntityByIdAsync(Guid jobId);
        public Task<JobDto> GetJobByIdAsync(Guid jobId);
        public Task<IEnumerable<JobDto>> GetAllJobsAsync(Guid companyId);
